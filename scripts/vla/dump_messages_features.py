...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--sample-token-key", default="sample_token", help="Preferred sample token key kept in meta.jsonl.")
    parser.add_argument("--timestamp-key", default="timestamp", help="Preferred timestamp key kept in meta.jsonl.")
    parser.add_argument(
        "--input-text-scope",
...
def make_meta_row(feature: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "sample_token": feature.get("sample_token"),
...
def build_feature(
    ...
    feature = {
        ...
        "sample_token": str(row.get(sample_token_key) or "") or None,
